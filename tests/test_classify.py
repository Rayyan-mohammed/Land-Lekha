...
def test_a_government_seal_does_not_make_a_land_record():
    ...
    r = classify(GOVT_HEALTH, words=40)
...
def test_one_kind_of_evidence_is_never_enough():
    ...
    assert classify("please complete the survey no later than Friday and return it", words=30)["is_land_document"] is False
    assert classify("the total area of the hall is 400 square metre, hectare rates apply", words=30)["is_land_document"] is False
