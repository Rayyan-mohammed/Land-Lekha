...
const FAQ = [
  ...
  [['Why does a page say numbers were read again?', 'पन्ने पर "अंक फिर पढ़े" क्यों लिखा है?'],
    ['Khasra, survey and registration numbers are the hardest thing to read, because Hindi and English digits look alike. When a number reads unsurely it is read once more by a reader that knows English digits only, which removes that confusion. The number still shows its confidence, and you check it as usual.',
      'खसरा, सर्वे और पंजीकरण संख्या पढ़ना सबसे कठिन है, क्योंकि हिंदी और अंग्रेज़ी के अंक मिलते-जुलते हैं। जब कोई संख्या ठीक से नहीं पढ़ी जाती, तो उसे एक बार फिर ऐसे रीडर से पढ़ाया जाता है जो केवल अंग्रेज़ी अंक जानता है, जिससे यह उलझन दूर हो जाती है। संख्या का विश्वास स्तर वैसे ही दिखता है, और आप उसे हमेशा की तरह जाँचते हैं।']],
  ...
  [['Can I get the records into Excel?', 'क्या अभिलेख Excel में मिल सकते हैं?'],
    ['Yes. On Records & GIS, search if you like, then press CSV. The file opens in Excel with Hindi names shown correctly, one row per record with every co-owner and khasra. The Documents list has its own CSV for a status report: whatever the filter and search select, with the status, confidence and how many fields each needs checked.',
      'हाँ। अभिलेख और मानचित्र पर चाहें तो खोजें, फिर CSV दबाएँ। फ़ाइल Excel में खुलती है और हिंदी नाम सही दिखते हैं; हर अभिलेख की एक पंक्ति, सभी सह-खातेदार और खसरों के साथ। प्रगति रिपोर्ट के लिए दस्तावेज़ सूची का अपना CSV है: जो छाँट और खोज चुनती है वही, स्थिति, विश्वास और कितने खाने जाँचने हैं — सहित।']],
  ...
  [['Can I keep a copy of the audit trail?', 'क्या ऑडिट लॉग की प्रति रखी जा सकती है?'],
    ['Yes. On the Audit trail, filter by kind of event or by person, then press CSV. The file holds the time, who, what, the subject and the IP for up to 1000 events.',
      'हाँ। ऑडिट लॉग पर घटना के प्रकार या व्यक्ति से छाँटें, फिर CSV दबाएँ। फ़ाइल में समय, किसने, क्या, किस पर और IP — 1000 घटनाओं तक — रहता है।']],
  [['It says the server cannot be reached. What do I do?', 'यह कहता है कि सर्वर से संपर्क नहीं हो सका। क्या करें?'],
    ['The office server is restarting or the network is down. You stay signed in and nothing is lost: wait a moment and press Try again. If it keeps happening, tell the administrator.',
      'कार्यालय का सर्वर फिर से चालू हो रहा है या नेटवर्क बंद है। आप साइन इन ही रहते हैं और कुछ नहीं खोता: थोड़ी देर रुककर "दोबारा कोशिश करें" दबाएँ। बार-बार हो तो प्रशासक को बताएँ।']],
