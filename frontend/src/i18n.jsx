...
export const HI = {
  ...
  'Check against the state register': 'राज्य रजिस्टर से मिलान करें',
  'simulated': 'सिम्युलेटेड',
  'Check': 'मिलान',
  'No matching parcel in the register': 'रजिस्टर में यह खसरा नहीं मिला',
  'entries': 'प्रविष्टियाँ',
  'field differs from the register': 'खाना रजिस्टर से अलग है',
  'fields differ from the register': 'खाने रजिस्टर से अलग हैं',
  'Every field matches the register': 'हर खाना रजिस्टर से मेल खाता है',
  'Corrections per 100 fields checked': 'हर 100 जाँचे गए खानों पर सुधार',
  'corrected of': 'सुधारे गए, कुल',
  'checked': 'जाँचे गए',
  'Field': 'खाना',
  'On this document': 'इस दस्तावेज़ पर',
  'In the register': 'रजिस्टर में',
  'A match means the two records agree. It is not evidence that the document is genuine.': 'मेल का अर्थ है दोनों अभिलेख एक जैसे हैं। यह प्रमाण नहीं कि दस्तावेज़ असली है।',
  ...
  'Field accuracy (checked by a person)': 'खानों की शुद्धता (जिन्हें व्यक्ति ने जाँचा)',
  'fields checked': 'खाने जाँचे गए',
  'approved without being checked': 'बिना जाँचे स्वीकृत',
  'median': 'माध्यिका',
