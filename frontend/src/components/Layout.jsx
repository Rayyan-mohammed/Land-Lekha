...
import { BarChart3, CircleHelp, ClipboardCheck, FileStack, LogOut, Map, Menu, ScrollText, ShieldCheck, Upload, Users, X } from 'lucide-react'
...
const NAV = [
  ...
  { to: '/real-samples', label: 'Real document check', icon: ShieldCheck, roles: [] },
